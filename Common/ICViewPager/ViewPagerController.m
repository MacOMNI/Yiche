...
#define kDefaultTabHeight 64.0 // Default tab height
#define kDefaultTabOffset 80.0 // Offset of the second and further tabs' from left
#define kDefaultTabWidth kScreenWidth/5
